...
export function EventView({ eventId, onBack }: { eventId: Id<"events">; onBack: () => void }) {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      {event.status === "active" && (
        <div className="card-professional p-6 mb-8 fade-in border-border/50">
      ...
      {scoringComplete && myScores && myScores.length > 0 && (
        <div className="card-professional mb-8 fade-in p-6 border-border/50">
    ...
    <div className="space-y-8">
      {hasPrizeWinners ? (
        <div className="fade-in space-y-6">
          <div className="card-professional bg-amber-500/5 border-amber-500/20 text-center p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {Object.values(groupedPrizeWinners).map((winnerRows: any[]) => {
              ...
              return (
                <div
                  key={first.prizeId}
                  className="card-professional border-teal-500/20 bg-teal-500/5 transition-all duration-300 p-6"
                >
                  ...
                  <div className="space-y-2">
                    {winnerRows
                      ...
                      .map((row: any) => (
                        <div key={row._id} className="rounded-lg border border-border/70 bg-background/70 px-3 py-2">
        ...
        <div className="card-professional bg-amber-500/5 border-amber-500/20 text-center fade-in p-8">
      ...
      <div className="fade-in" style={{ animationDelay: '0.3s' }}>
        ...
        <div className="card-professional overflow-hidden p-0 border-border/50">
