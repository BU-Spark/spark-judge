...
export function CodeAndTellScoringExplainer({
  ...
  return (
    <div className={`group relative inline-flex items-center gap-1.5 text-sm text-muted-foreground ${className}`}>
      ...
      <div className="pointer-events-none absolute bottom-full right-0 sm:left-1/2 z-50 mb-2 w-64 sm:w-72 sm:-translate-x-1/2 opacity-0 transition-opacity group-hover:opacity-100">
